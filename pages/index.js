        ...
        <section className=" min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            ...
            <ul className="flex items-center">
              ...
              <li><a href="#" target="_blank" className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8 ">Resume</a></li>
            </ul>
          </nav>
          ...
          <div className="text-3xl flex justify-center gap-16 py-3 text-gray-600 ">
            <a href="#" target="_blank"><AiFillTwitterCircle className="hover:text-[#160c0c]"/></a>
...
<div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px]  h-full border-t-[#3F3E45] ">
      <p className=" font-normal text-center text-[18px] leading-[27px] mb-[10px] md:ml-[30px] text-black">
